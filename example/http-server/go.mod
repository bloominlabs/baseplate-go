...
require (
	...
	github.com/bloominlabs/baseplate-go/config/env v0.0.0-20230514221259-ec7854972731 // indirect
	github.com/bloominlabs/baseplate-go/config/filesystem v0.0.0-20230514221259-ec7854972731 // indirect

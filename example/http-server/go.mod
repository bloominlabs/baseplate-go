...
require (
	...
	github.com/auth0/go-auth0 v0.12.0 // indirect
	...
	github.com/hashicorp/nomad/api v0.0.0-20221103033341-85f472189a2e // indirect
	...
	github.com/tailscale/tailscale-client-go v1.7.0 // indirect

...
require (
	github.com/bloominlabs/baseplate-go/config/env v0.0.0-20230730230838-96a1f424e7f0
	github.com/bloominlabs/baseplate-go/config/filesystem v0.0.0-20230730230838-96a1f424e7f0

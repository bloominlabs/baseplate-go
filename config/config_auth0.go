...
func (c *Auth0Config) RegisterFlags(f *flag.FlagSet) {
	...
	flag.StringVar(&c.Token, "auth0.token", getenv("AUTH0_TOKEN", ""), "Token to use to authenticate to auth0 (can be used instead of auth0.client_id + auth0.client_secret)")
